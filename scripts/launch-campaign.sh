...
echo "   1. Edit scripts/outreach-contacts.js with real contacts"
echo "   2. Run: node scripts/outreach-contacts.js"
echo "   3. Send emails manually or via mail service"
echo "   4. Post Reddit thread to relevant subreddits"
echo "   5. Submit to Hacker News Show"
echo "   6. Tweet the thread"
